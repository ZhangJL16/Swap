...
class Critic(nn.Module):
    def __init__(self, args):
        ...
        # self.max_action = args.n_actions
        # self.fc1 = nn.Linear(args.obs_shape * args.n_agents + args.n_actions * args.n_agents, 64)
        self.fc2 = nn.Linear(64, 64)
        self.fc3 = nn.Linear(64, 64)
