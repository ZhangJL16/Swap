...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate a persistent scheduler without learning.")
    parser.add_argument("--scenario", default="persistent_energy_tight")
    parser.add_argument("--scheduler", default="scheduler_sac")
    parser.add_argument("--checkpoint")
    parser.add_argument("--seeds", nargs="+", type=int, default=[0, 1, 2, 3, 4])
    parser.add_argument("--steps", type=int, default=5000)
    parser.add_argument("--output", default="artifacts/persistent/evaluation.json")
    ...
    for seed in args.seeds:
        ...
        if args.checkpoint:
            ...
            env.scheduler.actor.load_state_dict(checkpoint["actor"])
        env.reset(seed=seed)
