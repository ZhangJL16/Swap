...
class PersistentMetricAccumulator:
    ...
    def summary(self) -> dict[str, Any]:
        ...
        result: dict[str, Any] = {
            ...
            "backup_intervention_reward_events": int(round(self.counters["backup_intervention_reward_events"])),
...
def episode_record(
    ...
    *,
    ...
    return {
        ...
        "backup_intervention_reward_events": metrics["backup_intervention_reward_events"],
        "kappa_backup_steps": metrics["kappa_backup_steps"],
